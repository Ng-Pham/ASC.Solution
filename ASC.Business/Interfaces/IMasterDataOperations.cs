...
namespace ASC.Business.Interfaces
{
    public interface IMasterDataOperations
    {
        ...
        Task<List<MasterDataValue>> GetAllMasterValueAsync();
        ...
        Task<bool> UpdateMasterValueAsync(string orginalPartitionKey, string orginalRowKey, MasterDataValue value);
